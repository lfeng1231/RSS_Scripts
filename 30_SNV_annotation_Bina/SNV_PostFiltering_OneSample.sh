...
PANEL=/isilon/Analysis/onco/prog/built_packages/snv-post-filtering/resources_files_from_Bina/RUO_P2B_exon_targets_hg38_09282016_consolidated.bed
VCF_CROSSCON=nextflow_P2-1.crosscon.vcf

#Files no need to be modified
...
#Intermediate files
VCF_INPUT=input_$VCF_CROSSCON
VT_OUTPUT=vt_$VCF_CROSSCON
ANN_SNPEFF=ann_$VCF_CROSSCON
VCF_WITH_TRS=trs_$VCF_CROSSCON
ANN_HAS_EFFECT=effect_$VCF_CROSSCON
ANN_VT_BLOCK_DECOMP=vtblock_$VCF_CROSSCON
ANN_BINA=bina_$VCF_CROSSCON
ANN_UNFILTERED=unfiltered_$VCF_CROSSCON
ANN_FILTERED=filtered_$VCF_CROSSCON

#Step 0: Run cross-contamination detection tool


#Step 0.1 sort VCF files
