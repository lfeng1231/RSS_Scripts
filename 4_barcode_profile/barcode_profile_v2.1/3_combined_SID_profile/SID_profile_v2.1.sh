DIR=$(pwd)
s2b=sample2barcode.txt
R1_gz=subsampled_10M_Undetermined_S0_R1_001.fastq.gz
R2_gz=subsampled_10M_Undetermined_S0_R2_001.fastq.gz
...
#SID profile
echo barcode profile start
perl /home/users/fengl6/my_scripts/4_barcode_profile/barcode_profile_v2.1/3_combined_SID_profile/barcode_profile_v2.1.pl $DIR $s2b $R1 $NONPHIX_R1
echo barcode profile done
date

#qsub -q normal.q -pe smp 24 -N quick-test -V -j y -cwd SID_profile_v2.1.sh
